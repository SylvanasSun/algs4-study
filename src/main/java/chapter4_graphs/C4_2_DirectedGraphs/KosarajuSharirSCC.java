...
public class KosarajuSharirSCC {
    ...
    /**
     * Computes the strong components of the digraph {@code digraph}.
     *
    ...
    public static void main(String[] args) {
        InputStream inputStream
                = KosarajuSharirSCC.class.getResourceAsStream("/graph_file/C4_2_DirectedGraphs/" + args[0]);
        Digraph G = new Digraph(new Scanner(inputStream));
        ...
        Queue<Integer>[] components = (ArrayDeque<Integer>[]) new ArrayDeque[m];
        for (int i = 0; i < m; i++) {
